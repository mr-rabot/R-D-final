...
const plans = [
  {
    name: "Foundation",
    price: "$299",
    description: "Ideal for undergraduate projects and basic research needs.",
    features: [
  ...
  },
  {
    ...
    price: "$799",
    description: "Designed for PhD candidates and professional researchers.",
    features: [
  ...
  },
  {
    name: "Institutional",
    price: "Custom",
    description: "Customized solutions for universities and research labs.",
    features: [
      "Multiple Team Licenses",
    ...
    <section id="pricing" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl font-headline font-bold text-accent">Transparent Pricing</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            High-quality academic support structured to meet your specific research stage.
          </p>
        </div>
            ...
            <Card key={index} className={`relative flex flex-col rounded-3xl overflow-hidden transition-all duration-300 ${plan.highlight ? 'border-primary border-2 shadow-2xl scale-105 z-10' : 'border-none shadow-lg'}`}>
              {plan.highlight && (
                <div className="absolute top-0 right-0">
                  <Badge className="rounded-none rounded-bl-xl bg-primary px-4 py-1">Most Popular</Badge>
                </div>
              )}
