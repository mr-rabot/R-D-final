  ...
  return (
    <section id="about" ref={sectionRef} className="py-32 bg-white overflow-hidden">
      <div className={cn(
        ...
        <div className="flex flex-col items-center mb-40">
          <div className="relative flex flex-col items-center">
            ...
            <div className="mt-12 text-center w-full">
              <h3 className="text-4xl md:text-5xl lg:text-7xl font-headline font-bold text-slate-900 tracking-tight mb-3">
                {founder?.name || "Om Prakash Sinha"}
              </h3>
              <div className="space-y-1 mb-12">
                <p className="text-[11px] md:text-[14px] uppercase tracking-[0.4em] font-bold text-primary/80">
              ...
              <div className="space-y-10 flex flex-col items-center">
                <h2 className="text-5xl md:text-8xl lg:text-9xl font-headline font-bold text-accent leading-[0.95] tracking-tight mb-4">
                  Precision <br />
                  <span className="text-primary/90 italic text-4xl md:text-7xl lg:text-8xl">in Research</span>
                </h2>
                
                <div className="max-w-5xl mx-auto border-t border-slate-100 pt-10 mt-2">
                  <p className="text-xl md:text-3xl text-slate-600 font-light leading-relaxed text-center italic">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-28 w-full">
            {[
          ...
          <div className="pt-20">
            <Button 
              ...
              size="lg" 
              className="rounded-2xl px-14 h-18 bg-accent hover:bg-slate-900 text-white font-bold transition-all shadow-[0_20px_40px_rgba(0,0,0,0.3)] hover:-translate-y-1 active:scale-95 text-xl"
            >
        ...
        <div className={cn(
          "bg-[#0a0f1c] rounded-[60px] md:rounded-[100px] p-12 md:p-24 lg:p-32 text-white relative overflow-hidden shadow-[0_60px_120px_rgba(0,0,0,0.5)] border border-white/5 transition-all duration-1000",
          ...
          <div className="relative z-10 lg:grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                <h3 className="text-4xl md:text-7xl lg:text-8xl font-headline font-bold leading-tight">
                ...
                <div className="grid grid-cols-2 gap-12">
                  {(firmData?.stats || [
                    ...
                    <div key={i} className="space-y-3 group">
                      <div className="text-5xl md:text-8xl lg:text-9xl font-headline font-bold text-primary transition-transform duration-500 group-hover:scale-110 origin-left">
                        {stat.value}
                      </div>
                      <div className="text-[10px] lg:text-sm uppercase tracking-[0.3em] font-bold text-blue-300 opacity-60">
                        {stat.label}
                      </div>
                    </div>
                  ))}
